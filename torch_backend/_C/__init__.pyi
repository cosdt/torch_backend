...
class _NPUStreamBase:
    ...
    def __new__(cls, priority: Optional[int] = ..., stream_id: Optional[int] = ..., device_index: Optional[int] = ...,
                device_type: Optional[int] = ..., stream_ptr: Optional[int] = ...) -> _NPUStreamBase: ...
...
class _EventBase:
    ...
    def record(self, stream: _NPUStreamBase) -> None: ...
    def wait(self, stream: _NPUStreamBase) -> None: ...
    def query(self) -> bool: ...
