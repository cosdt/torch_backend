...
aclError aclmdlSetDump(const char* configPath) {
  return 0;
}
...
aclError aclrtSynchronizeStreamWithTimeout(
    aclrtStream stream,
    int32_t timeout) {
  return 0;
}
...
aclError aclrtQueryEventStatus(
    aclrtEvent event,
...
aclError aclopSetAttrBool(
    aclopAttr* attr,
    const char* attrName,
    uint8_t attrValue) {
  return 0;
}
aclError aclopSetAttrInt(
    aclopAttr* attr,
    const char* attrName,
    int64_t attrValue) {
  return 0;
}
aclError aclopSetAttrFloat(
    aclopAttr* attr,
    const char* attrName,
    float attrValue) {
  return 0;
}
aclError aclopSetAttrString(
    aclopAttr* attr,
    const char* attrName,
    const char* attrValue) {
  return 0;
}
aclError aclopSetAttrListInt(
    aclopAttr* attr,
    const char* attrName,
    int numValues,
...
aclError aclopSetAttrListFloat(
    aclopAttr* attr,
    const char* attrName,
    int numValues,
    const float* values) {
...
aclError aclSetTensorShape(
    aclTensorDesc* desc,
    int numDims,
    const int64_t* dims) {
  return 0;
}
aclError aclSetTensorShapeRange(
    aclTensorDesc* desc,
    size_t dimsCount,
    int64_t dimsRange[][ACL_TENSOR_SHAPE_RANGE_NUM]) {
  return 0;
}
aclError aclGetTensorDescDimV2(
...
aclError aclSetTensorPlaceMent(aclTensorDesc* desc, aclMemType type) {
  return 0;
};
