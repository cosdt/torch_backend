...
#include "backend/npu/impl/core/register/FunctionLoader.h"
#include "backend/npu/impl/framework/interface/LibAscendHal.h"

namespace at_npu {
namespace native {
#undef LOAD_FUNCTION
#define LOAD_FUNCTION(funcName) REGISTER_FUNCTION(libascend_hal, funcName)
#undef GET_FUNC
#define GET_FUNC(funcName) GET_FUNCTION(libascend_hal, funcName)
