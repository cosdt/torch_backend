...
#include "backend/npu/impl/framework/contiguous/contiguous_register.h"
...
using ShapeStrideStack = c10::SmallVector<
    c10::SmallVector<FormatShape, ViewAndBaseInfoStackNum>,
    MaxCombinedCasesNum>;
...
struct CachedContiguousOpt {
  ...
  c10::SmallVector<c10::SmallVector<int64_t, MAX_DIM>, CachedOptParaNum>
      cached_opt_parameters;
...
class TransContiguous {
 public:
  ...
  static ContiguousTensorDesc GetTensorDescInfo(
      const at::Tensor& src,
