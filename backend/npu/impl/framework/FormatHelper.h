...
#include "backend/npu/impl/framework/utils/NPUDefinition.h"
...
class FormatHelper {
 public:
  ...
  // 1. The storage size can be infered between NC1HWC0, NHWC, NC1HWC0_C04,
  // NCHW.
...
FormatShape FormatHelper::GetStorageSizes(
  ...
  AT_ERROR(
      "unsupport InferShape with format ",
