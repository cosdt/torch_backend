...
inline at::Tensor to_meta(const at::Tensor& t) {
  ...
  return at::native::empty_strided_meta_symint(
      t.sym_sizes(),
      t.sym_strides(),
      c10::make_optional(t.scalar_type()) /* dtype */,
      c10::make_optional(t.layout() /* layout */),
      c10::make_optional(c10::Device(at::kMeta)) /* device */,
...
inline c10::List<c10::optional<at::Tensor>> to_meta(
    const c10::List<c10::optional<at::Tensor>>& t_list) {
